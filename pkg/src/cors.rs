...
#[cfg(test)]
mod tests {
    use super::matches_origin_pattern;
    ...
    fn matches_wildcard_patterns() {
        assert!(matches_origin_pattern("https://app.example.com", "*"));
        assert!(matches_origin_pattern(
    ...
    #[test]
    fn rejects_invalid_or_unsupported_patterns() {
    ...
    #[test]
    fn keeps_subdomain_rules_strict() {
        assert!(!matches_origin_pattern(
            "https://example.com",
            "https://*.example.com"
        ));
