...
use http::Method;
use http::header::{ACCEPT, ACCEPT_LANGUAGE, AUTHORIZATION, CONTENT_TYPE, HeaderName};
...
pub fn get_cors_layer() -> CorsLayer {
    ...
    let mcp_session_id = HeaderName::from_static(MCP_SESSION_ID);
    ...
    CorsLayer::new()
        ...
        .expose_headers(ExposeHeaders::list(vec![mcp_session_id]))
...
mod tests {
    ...
    use http::header::{ACCESS_CONTROL_ALLOW_HEADERS, ACCESS_CONTROL_EXPOSE_HEADERS};
            ...
            .oneshot(
                Request::builder()
                    ...
                    .header(
                        ...
                        "content-type,accept-language,mcp-session-id",
                    )
                    .body(axum::body::Body::empty())
                    .unwrap(),
            )
