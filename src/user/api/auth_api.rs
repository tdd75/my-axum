...
use crate::{
    ...
    user::{
        ...
        use_case::auth::{
            change_password_use_case, forgot_password_use_case, get_me_use_case, login_use_case,
            logout_use_case, refresh_token_use_case, register_use_case, reset_password_use_case,
        },
    },
};
...
pub async fn get_me(
    ...
    new_transaction(&app_state, Some(current_user.clone()), |context| {
        Box::pin(get_me_use_case::execute(context))
    })
    .await
}
