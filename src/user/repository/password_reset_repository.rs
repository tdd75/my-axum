...
use crate::{core::context::Context, user::entity::password_reset_token};
...
pub async fn delete_expired(context: &Context) -> Result<(), sea_orm::DbErr> {
...
pub async fn delete_by_user_id(context: &Context, user_id: i32) -> Result<(), sea_orm::DbErr> {
    password_reset_token::Entity::delete_many()
