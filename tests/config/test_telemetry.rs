...
mod telemetry_tests {
    ...
    fn test_get_subscriber_with_default_filter() {
        let subscriber = get_subscriber("/tmp", false);
    ...
    fn test_get_subscriber_with_custom_filter() {
        let subscriber = get_subscriber("/tmp", true);
    ...
    fn test_init_subscriber_sets_global_default() {
        ...
        let _subscriber = get_subscriber("/tmp", false);
    ...
    fn test_get_subscriber_different_names() {
        let subscriber1 = get_subscriber("/tmp", false);
        let subscriber2 = get_subscriber("/tmp", true);
