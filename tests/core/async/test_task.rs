...
use my_axum::{
    core::{
        r#async::{ConcreteTaskHandler, TaskEvent},
        context::Context,
    },
    pkg::{
...
mod cleanup_expired_token_tests {
    ...
    use my_axum::{
        core::r#async::{TaskEvent, TaskType},
        user::entity::refresh_token,
        ...
        let remaining_tokens = app
            ...
            .transaction::<_, Vec<_>, sea_orm::DbErr>(|txn| {
                Box::pin(async move {
                    ...
                    let (tokens, _) = my_axum::user::repository::refresh_token_repository::search(
                        &context,
...
mod process_user_registration_tests {
    use my_axum::core::r#async::{TaskEvent, TaskType};
...
mod send_email_tests {
    use my_axum::core::r#async::TaskType;
